    ...
    render: function() {
      return (
        <div>
          ...
          <link href="../../css?family=Nunito:300,400,700" rel="stylesheet" />
              ...
              <div className="container">
                <div className="row align-items-center">
                  <div className="col-6 col-md-3 col-xl-4  d-block">
                    <h1 className="mb-0 site-logo"><a href="index.html" className="text-black h2 mb-0">Trade🔥Live<span className="text-primary" /> </a></h1>
                  </div>
                    ...
                    <nav className="site-navigation position-relative text-right" role="navigation">
                      <ul className="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block ml-0 pl-0">
                        ...
                        <li className="has-children">
                          <a href="#about-section" className="nav-link">Features</a>
                          <ul className="dropdown arrow-top">
                            <li><a href="#" target="_blank" className="nav-link"><span className="text-primary">Психология</span></a></li>
                            <li><a href="#our-team-section" className="nav-link">Еще что-то</a></li>
                        ...
                        <li><a href="train.html" className="nav-link">Sport</a></li>
                        <li><a href="kino.html" className="nav-link">Kino</a></li>
                        <li><a href="#testimonials-section" className="nav-link">Game</a></li>
              ...
              <div className="container">
                <div className="row align-items-center justify-content-center">
                  <div className="col-md-12" style={{position: 'relative'}} data-aos="fade-up" data-aos-delay={200}>
                    <img src="https://raw.githubusercontent.com/Alen767/image/main/3D_Animation_Style_generate_a_ball_in_a_transparent_background_2.png" alt="Image" className="img-fluid img-absolute" />
                    <div className="row mb-4" data-aos="fade-up" data-aos-delay={200}>
                      <div className="col-lg-6 mr-auto">
                        <h1>Две головы хорошо, а своя — лучше.</h1>
                        <p className="mb-5">Для принятия решения успешный трейдер не нуждается в мнении со стороны. Это фундаментальное правило которое нужно каждый день повторять по 10 раз перед зеркалом. Ни один даже самый опытный и авторитетный советник (трейдер,
                          аналитик, инсайдер) не заплатит за ВАШЕГО лося, потому что это ВАШ портфель, и решение по нему принимаете ВЫ!</p>
                        <div>
                          <a href="#" className="btn btn-primary mr-2 mb-2">Начать торговлю</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="row align-items-stretch">
                  <div className="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
                    <div className="unit-4 d-block">
                      <div>
                        <h3>TradingView</h3>
                        <p>Если вы не знаете, что делать в процессе торговли, вы должны следовать правилам, поскольку они сохранят вам жизнь.</p>
                        <p><a href="https://www.tradingview.com/chart">Перейти</a></p>
                      </div>
                    </div>
                  </div>
